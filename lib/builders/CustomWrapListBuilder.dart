...
class _CustomWrapListBuilderState extends State<CustomWrapListBuilder> {
  ...
  void initState() {
    ...
    widget.paginationProgressController?.streamController.stream
        .listen((event) {
    ...
    paginationSubscription =
        paginateSize.streamController.stream.listen((event) {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<int?>(
        initialData: paginateSize.currentValue,
        stream: paginateSize.streamController.stream,
              ...
              child: widget.sliver
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        ...(getBuilders(snapshot.data ?? paginate)),
                        if (widget.paginationProgressController != null)
                          StreamBuilder(
                              initialData: widget
                                  .paginationProgressController?.currentValue,
