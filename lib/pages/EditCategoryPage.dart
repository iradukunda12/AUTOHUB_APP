...
class EditCategoryPage extends StatefulWidget {
  ...
  const EditCategoryPage({super.key, required this.categoryData});
...
class _EditCategoryPageState extends State<EditCategoryPage> {
  ...
  void initState() {
    ...
    identityController.text = widget.categoryData.categoryIdentity;
    descriptionController.text = widget.categoryData.categoryDescription;
    forWhichNotifier.sendNewState(widget.categoryData.categoryFor);
  ...
  void updateCategory() {
    ...
    CategoryOperation()
        .updateCategory(
            identity, description, forWhich, widget.categoryData.categoryId)
        .then((value) {
      closeCustomProgressBar(context);

      if (value != null) {
        CategoryData categoryData = CategoryData.fromOnline(value);
        CategoryNotifier().updateCategory(widget.categoryData, categoryData);
        showToastMobile(msg: "Successfully updated the category");
        Navigator.pop(context);
      } else {
                      ...
                      child: MultiWidgetStateConsumer(
                          ...
                          widgetStateListBuilder: (context) {
                            bool enable =
                                ...
                                // ||
                                // forWhichNotifier.currentValue !=
                                //     widget.categoryData.categoryFor
                                ;
