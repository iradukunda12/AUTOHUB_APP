...
class SupabaseConfig {
  ...
  static const url = "https://hcjauxneavrqqkcmfghb.supabase.co";
  static const apiKey =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhjamF1eG5lYXZycXFrY21mZ2hiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTM2MjUxMTIsImV4cCI6MjAyOTIwMTExMn0.rIdht0nMgGHfIAuw0UHaFD-X-sLiTNdoqLe3qQ8FEwU";
  ...
  Future<DateTime?> getDatabaseTime() {
    return client.rpc("get_database_time").select().then((value) {
