...
class UserProfileService {
    ...
    userProfileStreamSubscription = SupabaseConfig.client
        ...
        .listen((event) {
          ...
          if (userDetails != null) {
            ...
            String? dob = userDetails[dbReference(Members.dob)];
  ...
  void handleDobChanged(String? dob) {
    MembersOperation.updateTheValue(dbReference(Members.dob), dob);
  }
    ...
    if (restricted) {
      LocalNavigationController().onUseNavigatorKey((navigatorState) {
        ...
        openDialog(
            ...
            const Text(
                "You have been restricted from AutoHub. You will be logged out."),
            [
              TextButton(
                  onPressed: () async {
                    Navigator.pop(context);
